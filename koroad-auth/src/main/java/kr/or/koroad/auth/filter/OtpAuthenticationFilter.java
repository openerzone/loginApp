...
public class OtpAuthenticationFilter extends AbstractAuthenticationProcessingFilter{
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		AbstractKoroadUserDetails user = (AbstractKoroadUserDetails)authentication.getPrincipal();
        ...
        OtpAuthenticationToken authRequest = new OtpAuthenticationToken(username, otpCode);
